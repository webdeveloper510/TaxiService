...
const AddCompany = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    describe_your_taxi_company: Yup.string().required("Describe your taxi number is required"),
    affiliated_with: Yup.string().required("Affiliated with is required"),
    phone:Yup.string().required("Phone number is required"),
    number_of_cars: Yup.string().required("Number of cars is required"),
    ...
    website: Yup.string().required(" Mark is required"),
    tx_quality: Yup.string().required("TX Quality is required"),
    contact: Yup.string().required("Contact is required"),
    first_name: Yup.string().required("First Name is required"),
    last_name: Yup.string().required("Last Name is required"),
    tel_contact_number: Yup.string().required("Tel Contact Number is required"),
