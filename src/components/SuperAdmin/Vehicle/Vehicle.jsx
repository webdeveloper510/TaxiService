                    ...
                    <Row>
                      {
                        ...
                        <Card className="cards-for-icons">
                          <div className="vehicle_inner">
                            <h6 className="text-center">Default Vehicle</h6>
                            <div className="image-container">
                              <Card.Img
                                variant="top"
                                src={defaultVehicle.vehicle_photo}
                                style={{ height: 225, width: 293 }}
                              />
                              <div class="icons-outer">
                                {role == "super" && (
                                  <div class="overlay">
                                    <Link
                                      to={`/super-admin/vehicle/editvehicle/${defaultVehicle._id}`}
                                    >
                                      <CButton
                                        id="btn_edit_vehicle"
                                        className="edit_vehicle"
                                      >
                                        <img
                                          src={editvehicleicon}
                                          alt="edit-icon"
                                    ...
                                    <CButton
                                      ...
                                      onClick={() => {
                                        setVisible(!visible);
                                        setSelectedId(defaultVehicle._id);
                                      }}
                                    >
                                      <img
                          ...
                          <Link
                            className="vehicle_linked"
                            to={`/${
                              role == "taxi" ? "taxi" : "super-admin"
                            }/vehicle/vehicle-details/${defaultVehicle._id}`}
                          >
                            <Card.Body>
                              <Card.Title>
                                {defaultVehicle.vehicle_model}
                              </Card.Title>
                              <Card.Text>
                                <div className="vehiclemodalinfo d-flex">
                                  ...
                                  <div className="vehicle-title-info">
                                    {/* <p>Gasoline</p> */}
                                    <p>{defaultVehicle.vehicle_type}</p>
                                    <p>{defaultVehicle.vehicle_number}</p>
                                    {/* <p>Joy Frenk</p> */}
                                    <p>
                                      {defaultVehicle.seating_capacity} Persons
                                    </p>
                                  </div>
                                </div>
                              </Card.Text>
                              ...
                              <Card className="cards-for-icons">
                                <div className="vehicle_inner">
                                  <div className="image-container">
                                    <Card.Img
                                      variant="top"
                                      src={data.vehicle_photo}
                                      style={{ height: 250, width: 293 }}
                                    />
                                    <div class="icons-outer">
                                      {role == "super" && (
                                        <div class="overlay">
